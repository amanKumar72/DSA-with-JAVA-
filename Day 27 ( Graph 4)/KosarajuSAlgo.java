...
public class KosarajuSAlgo {
  ...
  public static void topSort(ArrayList<Edge>[] graph, int curr, Stack<Integer> stack, boolean vis[]) {
    vis[curr] = true;
  ...
  public static void stronglyConnectedCompanents(ArrayList<Edge>[] graph, int V) {
  ...
  public static void main(String[] args) {
    ...
    stronglyConnectedCompanents(graph, V);
  }
}
